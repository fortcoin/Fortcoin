Contributing to FORT Core
============================

The FORT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FORT Core project, and is not to be
confused with overall FORT Network Protocol consensus changes.

Whether a pull request is merged into FORT Core rests with the project merge
...
Patches that change FORT consensus rules are considerably more involved than
...
Where a patch set proposes to change the FORT consensus, it must have been
...
The project leader is the release manager for each FORT Core release.
