...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"Fortcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"Fortcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Fortcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Fortcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Fortcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"Fortcoin", "startmasternode", &startmasternode, true, true, false},
        {"Fortcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Fortcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Fortcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Fortcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Fortcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Fortcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Fortcoin", "mnbudget", &mnbudget, true, true, false},
        {"Fortcoin", "preparebudget", &preparebudget, true, true, false},
        {"Fortcoin", "submitbudget", &submitbudget, true, true, false},
        {"Fortcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Fortcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Fortcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Fortcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Fortcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Fortcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Fortcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Fortcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"Fortcoin", "mnsync", &mnsync, true, true, false},
        {"Fortcoin", "spork", &spork, true, true, false},
        {"Fortcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
