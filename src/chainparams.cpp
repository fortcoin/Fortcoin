...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000004c0077ae1e33fc103a38fc8c42c27ecfb7db7fb7f7531a9b0248852ef76"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1496558297, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("043c72ece1d01a1d5f087a372b0665762d0a7482f4f1831391fc6a9914a3b4472db83aec273b1afa3e7ed78548b08bc189be97da43aebc6cd62e343fb94cdd8e65");
        nDefaultPort = 47899;
       ...
       vSeeds.push_back(CDNSSeedData("fortcoin seeds","seed.fortcoin.com"));
        ...
        strSporkKey = "043c72ece1d01a1d5f087a372b0665762d0a7482f4f1831391fc6a9914a3b4472db83aec273b1afa3e7ed78548b08bc189be97da43aebc6cd62e343fb94cdd8e65";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FORT: 1 day
        nTargetSpacing = 1 * 60;  // FORT: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "Fortcoin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "Fortcoin-testnet.seed2.fuzzbawls.pw"));
