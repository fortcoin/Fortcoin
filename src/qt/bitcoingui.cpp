                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FORT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FORT address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FORT Core"), this);
    aboutAction->setStatusTip(tr("Show information about FORT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FORT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FORT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FORT addresses"));
    ...
    openAction->setStatusTip(tr("Open a FORT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FORT Core help message to get a list with possible FORT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FORT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FORT network", "", count));
}
...
{
    QString strTitle = tr("FORT Core"); // default title
