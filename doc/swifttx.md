...
This mechanism has been integrated into Bitcore-Node-FORT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FORT-Project/insight-api-Fortcoin#web-socket-api](https://github.com/FORT-Project/insight-api-Fortcoin#web-socket-api) 
* API: [https://github.com/FORT-Project/insight-api-Fortcoin#swifttx-transactions](https://github.com/FORT-Project/insight-api-Fortcoin#swifttx-transactions) 
...
By default, the FORT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FORT Core daemon:
