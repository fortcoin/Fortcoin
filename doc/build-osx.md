...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/FORT-Project/FORT.git
        cd FORT
...
Once dependencies are compiled, see release-process.md for how the FORT-Qt.app
...
commands:
    ...
    echo -e "rpcuser=Fortcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/FORT/Fortcoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/FORT/Fortcoin.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/FORT/debug.log
