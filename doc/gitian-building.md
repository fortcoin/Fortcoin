...
*Setup instructions for a gitian build of FORT using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the FORT
...
- [Building FORT](#building-Fortcoin)
...
To build FORT (for Linux, OSX and Windows) just follow the steps under 'perform
